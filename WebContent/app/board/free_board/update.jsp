...
<body>
	...
	<c:if test="${not (loginUser.user_nickname eq fb.user_nickname)}">
		<script>
			alert("글쓴이가 아닙니다.");
			location
					.replace("${cp}/board/free_board/list.bo?page=${param.page}");
		</script>
	</c:if>
	${loginUser.user_nickname } / ${fb.user_nickname}
	<%@include file="../../../header.jsp"%>
	<div id="main">
		<form method="post" action="${cp}/board/free_board/update_ok.bo"
			...
			<table>
				...
				<tr>
					...
					<td><a href="javascript:postOn();">수정완료</a> <a
						href="${cp }/board/free_board/list.bo?page=${param.page}">목록</a></td>
				</tr>
			</table>
