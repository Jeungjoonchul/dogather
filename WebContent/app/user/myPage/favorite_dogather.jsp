	...
	<div id="mypage_container">
		...
		<div id="mypage_area">
        	<div id="top_meun">
                <table>
                  <tr>
                    <th id="mydogether" class="off">
                      <a href="${cp}/app/user/mypage/mydogather.jsp">마이 두게더</a>
                    </th>
                    <th id="category" class="on">
...
<script>
const favorite_dogather = '/dogather/app/user/mypage/favorite_dogather.jsp';
if("<%= request.getRequestURI() %>"==favorite_dogather){
	document.querySelector("#favorite_dogather").className = "on";
