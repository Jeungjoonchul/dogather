								...
								<c:if test="${member == loginUser.user_index}">
									<nav>
										<ul>
											...
											<li>
												<a href="${cp }/dg/post_write.dg?dp_type=cert&dg_index=${dg.dg_index}">
													<span class="purple">인증글</span> 쓰러가기
												</a>
											</li>
											<li>
												<a href="${cp }/dg/post_write.dg?dp_type=feed&dg_index=${dg.dg_index}">
													<span class="purple">피드</span> 쓰러가기
												</a>
											</li>
											<li>
												<a href="javascript:quitDg(${loginUser.user_index },${dg.user_index },${dg.dg_index })" id="quit_dg_btn">
													<span class="purple">두게더</span> 그만두기
												</a>
											</li>
										</ul>
									</nav>
					...
					<div class="dg_comm_header">
						...
						<c:choose>
							<c:when test="${dp_type eq 'feed' }">
								<li >
									<label class="filter_unchecked">전체<input type="radio" value="all" name="dp_type" id="dp_type_all"/></label>
								</li>
								<li >
									<label class="filter_checked">피드<input type="radio" value="feed" name="dp_type" id="dp_type_feed" checked/></label>
								</li>
								<li >
									<label class="filter_unchecked">인증<input type="radio" value="cert" name="dp_type" id="dp_type_cert"/></label>
								</li>
							</c:when>
							<c:when test="${dp_type eq 'cert' }">
								...
								<li >
									<label class="filter_unchecked">피드<input type="radio" value="feed" name="dp_type" id="dp_type_feed"/></label>
								</li>
								<li >
									<label class="filter_checked">인증<input type="radio" value="cert" name="dp_type" id="dp_type_cert" checked/></label>
								</li>
							</c:when>
							<c:otherwise>
								<li >
									<label class="filter_checked">전체<input type="radio" value="all" name="dp_type" id="dp_type_all" checked/></label>
								</li>
								<li >
									<label class="filter_unchecked">피드<input type="radio" value="feed" name="dp_type" id="dp_type_feed"/></label>
								</li>
						...
						<c:choose>
							...
							<li >
								<label class="filter_checked">좋아요<input type="radio" value="dp_like_cnt" name="dp_align" id="dp_align_like" checked/></label>
							</li>
							<li >
								<label class="filter_unchecked">등록일<input type="radio" value="dp_reg_date" name="dp_align" id="dp_align_date"/></label>
							</li>
							</c:when>
							<c:otherwise>
								<li >
									<label class="filter_unchecked">좋아요<input type="radio" value="dp_like_cnt" name="dp_align" id="dp_align_like"/></label>
								</li>
								<li >
									<label class="filter_checked">등록일<input type="radio" value="dp_reg_date" name="dp_align" id="dp_align_date" checked/></label>
								</li>
							</c:otherwise>
						</c:choose>
