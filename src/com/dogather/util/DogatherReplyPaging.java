...
public class DogatherReplyPaging {
	// 현재 페이지 번호
	private int page;
	// 전체 게시글 개수
	...
	public DogatherReplyPaging(String paramPage, int totalCnt) {
		this.totalCnt = totalCnt;
		totalPage = (this.totalCnt - 1) / pageSize + 1;
		page = (paramPage == (null)) || (paramPage.equals("")) ? totalPage
				: Integer.parseInt(paramPage) > totalPage ? totalPage : Integer.parseInt(paramPage);
